...
DEFAULT_AGENT_IDENTITY = (
    "You are Orewa Agent 4, an independent coding assistant configured for Z.ai GLM. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Orewa Agent 4, a Hermes-derived agent fork. When the user needs help with "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Orewa Agent 4 itself — its CLI, config, models, providers, tools, "
